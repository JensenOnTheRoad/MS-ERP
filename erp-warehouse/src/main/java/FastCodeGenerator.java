...
public class FastCodeGenerator {
    ...
    // 初始化数据
    final static String table_name_list = "warehouse,storage_record";
    final static String module_name = "erp-warehouse";
    final static String url = "localhost:3306";
    final static String database = "erp_warehouse";
    final static String username = "root";
    final static String password = "toor";

    final static String db_url = "jdbc:mysql://" + url + "/" + database + "?characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
